...
------------------ */b.behaviors.removeEmptyRegions={attach:function attach(b){a(".layout > .layout__region:not(.layout-builder__region)",b).once("removeEmpty").each(function(){a(this).children().length||a(this).remove()})}/* BACK TO TOP
